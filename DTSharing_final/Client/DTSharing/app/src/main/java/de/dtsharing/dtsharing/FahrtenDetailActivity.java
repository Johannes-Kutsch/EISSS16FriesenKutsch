            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(user.getInt("sequence_id_departure_station") == partner.getInt("sequence_id_departure_station")){
                        ...
                        _departureUserName1.setText(user.getString("user_id")+" steigt ein\n"+partner.getString("user_id")+" steigt ein");
                        ...
                        _departureUserName1.setText(partner.getString("user_id")+" steigt ein");
                        _departureUserName2.setText(user.getString("user_id")+" steigt ein");
                        ...
                        _departureUserName1.setText(user.getString("user_id")+" steigt ein");
                        _departureUserName2.setText(partner.getString("user_id")+" steigt ein");
                        _departureStationName1.setText(user.getString("departure_station_name"));
                    ...
                    if(user.getInt("sequence_id_target_station") == partner.getInt("sequence_id_target_station")){
                        ...
                        _targetUserName2.setText(user.getString("user_id")+" steigt ein\n"+partner.getString("user_id")+" steigt ein");
                        ...
                        _targetUserName1.setText(partner.getString("user_id")+" steigt ein");
                        _targetUserName2.setText(user.getString("user_id")+" steigt ein");
                        ...
                        _targetUserName1.setText(user.getString("user_id")+" steigt ein");
                        _targetUserName2.setText(partner.getString("user_id")+" steigt ein");
